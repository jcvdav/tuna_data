...
year_5deg_raw <- read_csv("data/raw/wcpfc/year_5deg_longline_flag/year_5deg_longline_flag.csv") |>
  clean_names()
...
# EXPORT #######################################################################
saveRDS(clean, "data/processed/wcpfc/wcpfc_year_5deg_longline_flag.rds")
