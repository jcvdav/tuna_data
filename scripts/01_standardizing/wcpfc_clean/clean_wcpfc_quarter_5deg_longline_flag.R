...
quarter_5deg_raw <- read_csv("data/raw/wcpfc/quarter_5deg_longline_flag/quarter_5deg_longline_flag.csv") |>
  clean_names()
...
# EXPORT #######################################################################
saveRDS(clean, "data/processed/wcpfc/wcpfc_quarter_5deg_longline_flag.rds")
